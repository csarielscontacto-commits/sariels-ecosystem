...
export class MarquinhosUI {
    ...
    init() {
            ...
            <div class="m-ad-modal-overlay" id="m-ad-modal-overlay">
                <div class="m-ad-modal" id="m-ad-modal">
                    ...
                    <div class="m-ad-modal-body">
                        ...
                        <div class="m-ad-pago-info" id="m-ad-pago-info">
                            <!-- Se llena dinámicamente con obtenerDatosPago() -->
                        </div>
        ...
        style.textContent = `
            ...
            .m-burbuja {
                ...
                font-size: 1.8rem;
                transition: box-shadow 0.3s ease, transform 0.2s ease, background 0.4s ease, border 0.4s ease;
                position: relative;
            }
            .m-burbuja:hover {
            ...
            .m-burbuja.ad-basico {
                background: linear-gradient(135deg, #3ecf6e, #269350);
                border: 1px solid rgba(62,207,110,0.5);
                box-shadow: 0 8px 32px rgba(62,207,110,0.35);
            }
            .m-burbuja.ad-basico .m-ad-label { background: #3ecf6e; }
            .m-burbuja.ad-estandar {
                background: linear-gradient(135deg, #f7d44a, #b8923a);
                border: 1px solid rgba(247,212,74,0.6);
                box-shadow: 0 8px 32px rgba(247,212,74,0.4);
            }
            .m-burbuja.ad-estandar .m-ad-label { background: #f7d44a; }
            .m-burbuja.ad-premium {
                background: linear-gradient(135deg, #ff9a3c, #c9691a);
                border: 1px solid rgba(255,154,60,0.65);
                box-shadow: 0 8px 36px rgba(255,154,60,0.45);
                animation: bubble-pulse 1.8s ease-in-out infinite;
            }
            .m-burbuja.ad-premium .m-ad-label { background: #ff9a3c; }
            .m-burbuja.ad-patrocinado {
                background: linear-gradient(135deg, #ff3366, #a3123f);
                border: 1px solid rgba(255,51,102,0.7);
                box-shadow: 0 8px 40px rgba(255,51,102,0.55);
                animation: bubble-pulse 1.2s ease-in-out infinite;
            }
            .m-burbuja.ad-patrocinado .m-ad-label { background: #ff3366; color: #fff; }
            ...
            .m-ad-modal {
                ...
                max-height: 85vh;
                overflow-y: auto;
                background: var(--m-glass, rgba(11,20,26,0.97));
            ...
            .m-ad-input:focus, .m-ad-textarea:focus {
                border-color: #f7d44a;
            }
            .m-ad-niveles {
                display: flex;
            ...
            .m-ad-btn-comprar:hover { transform: scale(1.03); }
        ...
        const adsBtn = document.getElementById('m-btn-ads');
        const adLabel = document.getElementById('m-ad-label');
        const adModalOverlay = document.getElementById('m-ad-modal-overlay');
        const adModalCerrar = document.getElementById('m-ad-modal-cerrar');
        const adBtnComprar = document.getElementById('m-ad-btn-comprar');
        ...
        bubble.addEventListener('click', (e) => {
            // 🆕 Si se hizo click en la etiqueta AD, mostrar el anuncio en vez de abrir el chat
        ...
        adModalCerrar.addEventListener('click', () => {
        ...
        adBtnComprar.addEventListener('click', () => {
    ...
    // ================================================================
    // ===== 🆕 PUBLICIDAD ALGORÍTMICA =====
    // ================================================================

    /**
     * Inicializa el ciclo de publicidad: carga un anuncio ya al arrancar
     * y luego rota cada cierto intervalo (por defecto 45s)
     */
    ...
    /**
     * Cambia el color/estilo de la burbuja según el nivel del anuncio activo.
     * Si no hay anuncio, restaura el estilo original.
     */
    mostrarAnuncioEnBurbuja(anuncio) {
        ...
        // Limpiar clases de nivel anteriores
    ...
    /**
     * Se ejecuta al hacer click en la etiqueta "AD" de la burbuja:
     * registra el click y muestra el anuncio (alert simple o abre la URL)
     */
    clickAnuncio() {
    ...
    /**
     * Abre el modal de compra de publicidad y carga los datos de pago
     */
    ...
    /**
     * Lee los datos de pago (cuenta, CLABE, titular) desde localStorage.
     * El admin los edita desde dashboard-emerald.html guardando la misma clave.
     */
    obtenerDatosPago() {
        try {
        ...
        // Valores por defecto si el admin aún no configuró nada
        return {
    ...
    /**
     * Envía el formulario del modal a Engine.comprarPublicidad()
     */
