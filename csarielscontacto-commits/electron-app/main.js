...
function createWindow() {
  ...
  // CAMBIA ESTA URL POR TU DOMINIO EN PRODUCCIÓN
...
ipcMain.on('csariels:getUser', (event) => {
  // Aquí puedes enviar información del usuario desde el navegador
  event.reply('csariels:userData', {
    browser: 'Csariel\'s Browser',
    version: '1.0.0',
    rewards: {
      totalMinutos: minutosAcumulados,
      megasGanados: Math.floor(minutosAcumulados / 10) * 50
    }
  });
});
...
console.log('◈ Csariel\'s Browser v1.0.0');
